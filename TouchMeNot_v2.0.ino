 ...
 * updated on 05_07_2017
*/

/////////////////////////////////////////////////////////////
//SET PARAMETERS HERE//
int rep = 10; // number of repetitions of the stimulus (tap)
int isi1 = 30000; // inter-stimulus interval in milliseconds "1 MINUTE" (30sec isi1 + 24sec isi2 +5sec LEDdelay + 1sec loop delay)
int isi2 = 24000;
int LEDdelay = 5000;
...
void loop() 
{
  ...
  do {
    sensorValAfter = analogRead(knockSensor);  //keep reading the sensor value until 
  
                        //it is above the set threshold (every tap event)
  }
  while (sensorValAfter<sensorValBefore);
